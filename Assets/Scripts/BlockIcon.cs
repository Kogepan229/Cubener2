...
public class BlockIcon : Graphic
{
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        Vector3[] vertices = new Vector3[]{
            ...
            new Vector3(position.x - iconSize / 2, position.y + sizeB, position.z),                    // Top:3
            new Vector3(position.x + iconSize / 2, position.y + sizeB, position.z),                    // Top:6

            // Front
            new Vector3(position.x - iconSize / 2, position.y + sizeB, position.z),                    // Front:1,4
            new Vector3(position.x,                position.y - iconSize / 2, position.z),             // Front:2,5
            new Vector3(position.x - iconSize / 2, position.y - sizeB, position.z),                    // Front:3
            ...
            new Vector3(position.x + iconSize / 2, position.y - sizeB, position.z),                    // Right:2,5
            new Vector3(position.x,                position.y - iconSize / 2, position.z),             // Right:3
            new Vector3(position.x + iconSize / 2, position.y + sizeB, position.x),                    // Right:6
        };
