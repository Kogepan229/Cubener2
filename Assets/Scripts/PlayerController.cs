...
public class PlayerController : MonoBehaviour
{
    ...
    private void UpdatePlayerInput()
    {
        ...
        player.toolBar.ShiftNumberInFocus(scroll);
    }
    ...
    private void MoveProc()
    {
        ...
        move += viewAngleTransform.right * inputHorizontal * player.HorizontalSpeed;
        move += viewAngleTransform.forward * inputVertical * player.HorizontalSpeed;
        move += Vector3.up * -inputLShift * player.VerticalSpeed;
        move += Vector3.up * inputSpace * player.VerticalSpeed;
        body.velocity = move;
    }
